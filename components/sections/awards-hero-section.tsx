    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        <p className="text-xl text-muted-foreground leading-relaxed text-pretty max-w-4xl mx-auto mb-8">
          DEVCODEWEB has been recognized for excellence in web development, innovation, and client satisfaction. Led by
          CEO Nikhil Kumawat and Co-Founder Vivek Kumawat, our commitment to quality has earned us prestigious awards
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-2xl mx-auto">
          ...
          <div className="text-center">
            <div className="font-heading font-bold text-3xl text-primary mb-2">1</div>
